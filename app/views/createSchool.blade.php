...
@section('content')
	...
	{{ Form::open(array('action' => 'SchoolController@postCreate', 'class' => 'form-horizontal')) }}
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<select name="country" class="form-control turn-to-ac" placeholder="Type your country" autocomplete="off" autocorrect="off" autofocus="autofocus">
